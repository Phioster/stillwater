...
const SUITES := [
	...
	"res://tests/test_angler_motion.gd",
	"res://tests/test_angler_zug.gd",
	...
	"res://tests/test_ghost_bar.gd",
	"res://tests/test_spring_and_shake.gd",
	"res://tests/test_audio.gd",
	"res://tests/test_settings.gd",
	"res://tests/test_save_backups.gd",
	"res://tests/test_glide_scroll.gd",
	"res://tests/test_order_and_bait.gd",
	"res://tests/test_virtual_list.gd",
	"res://tests/test_potions.gd",
